...
example_factorial.out: runtime.o gc.o examples/factorial.stella
	...
	gcc -std=c11 -g3 -fsanitize=address,undefined runtime.o gc.o TEMPORARY_factorial.c -I. -o example_factorial.out
...
example_logical_operations.out: runtime.o gc.o examples/logical_operations.stella
	...
	gcc -std=c11 -g3 -fsanitize=address,undefined runtime.o gc.o TEMPORARY_logical_operations.c -I. -o example_logical_operations.out
...
example_square_numbers.out: runtime.o gc.o examples/square_numbers.stella
	...
	gcc -std=c11 -g3 -fsanitize=address,undefined runtime.o gc.o TEMPORARY_square_numbers.c -I. -o example_square_numbers.out

gc.o: stella/gc.h stella/gc.c
	gcc -std=c11 -g3 -fsanitize=address,undefined -Werror -c stella/gc.c

runtime.o: stella/runtime.h stella/runtime.c stella/gc.h
	gcc -std=c11 -g3 -fsanitize=address,undefined -Werror -c stella/runtime.c
